import { getRecentMovements } from '@/services/order.service'
...
const parseRecentMovements = movements => {
  return movements.map(movement => ({
    ...movement,
    time: timeAgo(movement.createdAt),
  }))
}

const RecentMovements = async () => {
  const recentMovements = await getRecentMovements()
  const parsedMovements = parseRecentMovements(recentMovements)
  return (
