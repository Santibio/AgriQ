...
const initialProducts: Omit<Product, "id">[] = [
  ...
  { code: "22011", name: "kreen", category: "hortalizas", type: "tuberculosRaices", presentation: "paquete", active: true, price: 3000, image: `https://res.cloudinary.com/${process.env.CLOUDINARY_NAME}/image/upload/v1757869281/kt6txkzx9tq8qm9idiux.png`, createdAt: new Date(), updatedAt: new Date() },
  ...
  { code: "22021", name: "rabano negro", category: "hortalizas", type: "tuberculosRaices", presentation: "paquete", active: false, price: 0, image: `https://res.cloudinary.com/${process.env.CLOUDINARY_NAME}/image/upload/v1757870755/hxylntl2fv8hx9llnj0z.jpg`, createdAt: new Date(), updatedAt: new Date() },
  { code: "22031", name: "rabano rojo", category: "hortalizas", type: "tuberculosRaices", presentation: "paquete", active: false, price: 0, image: `https://res.cloudinary.com/${process.env.CLOUDINARY_NAME}/image/upload/v1757869316/x3d3yoilnjdv1su632sy.png`, createdAt: new Date(), updatedAt: new Date() },
  { code: "22041", name: "radicchetta", category: "hortalizas", type: "tuberculosRaices", presentation: "paquete", active: false, price: 0, image: `https://res.cloudinary.com/${process.env.CLOUDINARY_NAME}/image/upload/v1757870881/skskhn3gilki7y9hpo37.jpg`, createdAt: new Date(), updatedAt: new Date() },
